      ...
      <WalletProvider>
        {({ provider, account, connectWallet, disconnectWallet }) => (
          <>
            ...
            <Head>
              <title>How It Works | ETH Token Tool</title>
              <meta
                name="description"
                content="Step-by-step guide to launching your Ethereum token – no coding required, secure, fast, and affordable."
              />
              <meta property="og:title" content="How It Works - Ethereum Token Creator" />
              <meta
                property="og:description"
                content="Create your Ethereum token with no code. Launch your coin on blockchain securely and instantly."
              />
            ...
            <div className="container mx-auto p-6 max-w-3xl bg-background text-black">
              ...
              <section className="mb-12 p-6 bg-muted rounded-xl animate-fadeIn">
                ...
                <p className="text-black font-sans mb-4">
                  Follow these simple steps to create and launch your token on the Ethereum blockchain with Us:
                </p>
                <ol className="list-decimal list-inside space-y-4 text-black font-sans">
                  ...
                  <li>
                    <span className="font-bold">Switch to Ethereum Network:</span> Ensure your MetaMask wallet is set to the Ethereum network. If it’s not listed, add it as a custom network using details from{' '}
                    <a
                  ...
                  <li>
                    <span className="font-bold">Pay the Platform Fee:</span> Approve a small platform fee (0.03 ETH) via MetaMask to initiate the token creation process.
                  </li>
                  <li>
                    <span className="font-bold">Deploy Your Token:</span> After the fee is paid, approve the second transaction to deploy your token contract on Ethereum. This takes just a few seconds!
                  </li>
                  <li>
                    <span className="font-bold">View Your Token:</span> Once deployed, you’ll receive a link to view your token on Etherscan, confirming its creation on the blockchain.
                  </li>
                  <li>
              ...
              <section className="p-6 bg-muted rounded-xl animate-fadeIn">
                ...
                <ul className="list-disc list-inside space-y-4 text-black font-sans">
                  ...
                  <li>
                    <span className="font-bold">Secure and Decentralized:</span> Built on the Ethereum blockchain for maximum security and transparency.
                  </li>
                  <li>
                    <span className="font-bold">Affordable:</span> Minimal fees to get started—only 0.03 ETH to deploy your token.
                  </li>
                  <li>
